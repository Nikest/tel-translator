...
// Порт для внешнего мира (Render, Railway, Docker, etc.)
const PORT = process.env.PORT || 8080;

// Создаем простой HTTP сервер для health-check (полезно для облаков)
...
wss.on('connection', (connection) => {
    ...
    // 1. Подключение к OpenAI Realtime API
    ...
    // Функция инициализации сессии с нужными языками
...
3. Keep your voice neutral. Do not add conversational fillers. Just translate.`,
                voice: 'alloy',
                input_audio_format: 'g711_ulaw',  // Формат телефона
                output_audio_format: 'g711_ulaw', // Формат телефона
                turn_detection: {
                    type: 'server_vad',
                    threshold: 0.5,
